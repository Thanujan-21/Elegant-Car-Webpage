...
<body>
	...
	<section>
	<?php
	//create  a session to record the advertisment ID
	$_SESSION["id"]=$_GET["id"];
	//connect with the database
		...
		$sql="SELECT * FROM `tblads` WHERE `ADregistration` = ".$_SESSION["id"].";";
	...
	<div class="form-style-5">
		<form action="EditAds.php" method="post" enctype="multipart/form-data">
		<fieldset>
		<legend>Product Info</legend>
		<p>
		Category  <select name="lstCategory" title="Category">
			<option value="Car"<?php if($row["Category"] == "Car") {echo "Selected"; }?>>Car</option>
    		...
    		<option value="Truck"<?php if($row["Category"] == "Truck") {echo "Selected"; }?>>Truck</option>
  			...
  			<input type="text" name="txtBrand" placeholder="Brand *" value="<?php echo $row["Brand"];  ?>">
  			<input type="text" name="txtModel" placeholder="Model *" value="<?php echo $row["Model"];  ?>">
  			<input type="text" name="txtPrice" placeholder="Price *" value="<?php echo $row["price"];  ?>">
