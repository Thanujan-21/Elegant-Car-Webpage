...
//sql Query
	$sql = "SELECT * FROM `tblads` WHERE `email`='".$_SESSION["userName"]."';";
...
//Execute the query against the database
	...
	?>
			<div class="box">
				...
				<p>
					<a href='EditmyAds.php?id=<?php echo $row["ADregistration"];  ?>'>Edit</a>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a href='DeleteADS.php?id=<?php echo $row["ADregistration"];  ?>'>Delete</a>
		  		</p>
			</div>
